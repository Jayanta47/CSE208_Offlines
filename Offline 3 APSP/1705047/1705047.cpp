...
{
    // Preapre the distance and predecessor matrices
...
//            if (g.getShortestPathWeight(u-1, v-1) == INFINITY || g.getShortestPathWeight(u-1, v-1)==0)
//            {
//                Println("No shortest path between "<<u<<" "<<v<<endl);
//            }
//            else
//            {
//                Println("Shortest Path Weight: "<<g.getShortestPathWeight(u-1,v-1));
